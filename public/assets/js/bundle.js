...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function gerarNovoCpf() {
      ...
      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].GeraDig(cpfSemDigito);
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].GeraDig(cpfSemDigito + digito1);
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    key: "gerarNovoCpf",
    value: function gerarNovoCpf() {
      var CpfSD = this.cpflimpo.slice(0, -2);
      var digito1 = ValidaCPF.GeraDig(CpfSD);
      var digito2 = ValidaCPF.GeraDig(CpfSD + digito1);
    ...
    key: "GeraDig",
    value: function GeraDig(CadastroPessoaFisica) {
      var contador = 0;
      var tamanho = CadastroPessoaFisica.length + 1;
      var _iterator = _createForOfIteratorHelper(CadastroPessoaFisica),
        _step;
      try {
